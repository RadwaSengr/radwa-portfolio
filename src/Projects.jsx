...
function Projects() {
  const projects = [
    { id: 1, name: 'BreastCancerCare-AI 🩺', desc: 'Top 5 Finalist, AI Hackathon. Developed the front-end interface for an AI-powered healthcare application focused on breast cancer care.', tech: ['HTML', 'CSS', 'TypeScript', 'React', 'Bootstrap'], demo: 'https://breastcare-futwr2je.manus.space/', image: breastCancerImg },
    { id: 2, name: 'SAKINA Web App 📿', desc: "Designed and implemented a responsive and intuitive user interface for the SAKINA platform, prioritizing user experience.", tech: ['HTML', 'CSS', 'TypeScript', 'React'], demo: 'https://sakina-shop-aqsfyuds.manus.space/', image: sakinaImg },
