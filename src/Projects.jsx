...
function Projects() {
  const projects = [
    ...
    { id: 3, name: 'Wonderland Restaurant 🍽️', desc: 'Built a visually appealing and dynamic front-end for a restaurant website, featuring interactive menus and engaging layouts.', tech: ['HTML', 'CSS', 'JavaScript'], demo: 'https://radwasengr.github.io/Wonderland-Restaurant/', image: wonderlandImg }
  ];
